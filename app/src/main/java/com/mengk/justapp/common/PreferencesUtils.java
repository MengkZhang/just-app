...
//        SharedPreferences.Editor editor = settings.edit();
    ...
    public static String getString(Context context, String shareFileName, String key, String defaultValue) {
        SharedPreferences sp = context.getSharedPreferences(shareFileName, Context.MODE_MULTI_PROCESS);
    ...
    public static void clearString(Context context, String shareFileName) {
        SharedPreferences sp = context.getSharedPreferences(shareFileName, Context.MODE_MULTI_PROCESS);
        SharedPreferences.Editor editor = sp.edit();
        editor.clear();
        editor.apply();
    ...
    public static void clearBoolean(Context context, String shareFileName) {
        SharedPreferences sp = context.getSharedPreferences(shareFileName, Context.MODE_MULTI_PROCESS);
        SharedPreferences.Editor editor = sp.edit();
        editor.clear();
        editor.apply();
    ...
    public static boolean getSPUpdateData(Context context, String fileName) {
    ...
    public static void saveSPIsUpdateData(Context context, boolean value, String fileName) {
        try {
            SharedPreferences sp = context.getSharedPreferences(fileName, Context.MODE_PRIVATE);
            SharedPreferences.Editor edit = sp.edit();
            edit.putBoolean("isupdate",value);
            edit.apply();
        } catch (Exception e) {
            e.printStackTrace();
        }
